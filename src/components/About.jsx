        ...
        <div className="w-full ">
          ...
          <div className="w-full  ">
            <p className="text-gray-400 text-base lg:text-lg text-justify">
              I am deeply passionate about technology and the transformative
              potential of data. Throughout my academic journey in Information
              Technology, I've cultivated a strong statistical foundation and
              fostered a collaborative mindset. My focus lies in harnessing data
              science to solve intricate problems, proficiently employing Java
              and diverse web technologies to translate technical knowledge into
              impactful, real-world applications.
            </p>
            <br />
            <p className="text-gray-400 text-base lg:text-lg text-justify">
              Driven by an insatiable curiosity and a commitment to continual
              growth, I eagerly seek opportunities to contribute innovative
              solutions in the ever-evolving landscape of data analytics.
            </p>
            <div className="w-full flex justify-center items-center md:justify-start pt-3"> 
